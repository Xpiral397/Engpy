...
const CloseIcon: React.FC<IconSvgProps> = ({onClick, className}) => {
    return (
        <svg onClick={onClick} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className + "w-8 h-8 text-indigo-800"}>
