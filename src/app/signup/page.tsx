...
export default function LoginPage() {
    ...
    return (
        (
            <div className='closure_select w-full bg-gradient-to-r from-slate-600 via-purple-900 to-slate-900 font-[sans]'>
                <div className=''>
                ...
                <div className='flex flex-col items-center  justify-center '>
                    ...
                    <ul className=' flex-row  bg-white shadow-xl sm:py-4 sm:px-4 rounded-md'>
                        ...
                        {
                            pass ?
                                <button onClick={SingUp} className='w-full mt-10 hover:translate-y-1 resize:none duration-500 hover:animate-pulse text-slate-100 rounded-md px-8 py-1 bg-gradient-to-r from-slate-800 via-purple-700 text-[18px] to-purple-900  mb-2'> Sign up </button>
                                :
